...
// pre<script> lifecycle hook). worker.ts imports "../wasm/qrk_wasm.js",
...
const marker = path.join(debugUiDir, "src", "wasm", "qrk_wasm.js");

if (!existsSync(marker)) {
  console.error(
    [
      "",
      "error: debug-ui/src/wasm/qrk_wasm.js is missing.",
      "",
