...
/// Grayscale erosion with an odd square structuring element.
...
/// Grayscale dilation with an odd square structuring element.
...
/// Erode into caller-owned storage, reusing `workspace`.
...
/// Dilate into caller-owned storage, reusing `workspace`.
...
/// Open into caller-owned storage, reusing `workspace`.
...
/// Close into caller-owned storage, reusing `workspace`.
