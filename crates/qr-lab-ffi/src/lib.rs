//! C ABI (+ Android JNI) surface for QR Lab.
//!
//! Mobile consumers never call `qr-lab-core` directly: they load `libqrk_ffi`
...
use qr_lab::image::{Gray8View, Gray8ViewMut};
...
use qr_lab::{downscaled_dims, scan, DecodedCode, Detections, LumaView, ScanOptions, StageTimings};
use serde::Serialize;
...
pub unsafe extern "C" fn qrk_estimate_line_blur_luma_v1(
    ...
    let length = qr_lab::imgproc::blur::estimate_line_length(source, direction.theta_radians);
