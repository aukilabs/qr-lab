//! QR detection, decoding, robust recovery, and temporal scanning for QR Lab.
//!
//! Prefer the ergonomic [`Scanner`] / [`ScannerConfig`] facade for application
//! code. Lower-level entry points ([`scan`], [`scan_robust`], [`detect`]) remain
//! available for benchmarks and specialized pipelines.
