...
pub struct TripletCandidate {
    /// Top-left finder center `[x, y]`.
    pub tl: [f64; 2],
    /// Top-right finder center `[x, y]`.
    pub tr: [f64; 2],
    /// Bottom-left finder center `[x, y]`.
    pub bl: [f64; 2],
    /// Estimated module width from the triplet geometry.
    pub module: f64,
    /// Estimated QR module dimension (snapped toward a legal version size).
    pub dimension: u32,
    /// Residual of the dimension snap; lower is better.
    pub snap_error: f64,
    /// Polarity inherited from the contributing finders.
    pub inverted: bool,
