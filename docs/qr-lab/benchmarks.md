# QR Lab modularization benchmarks
...
Baseline revision: `bbac779` (immediately before QR Lab modularization).
...
| Scanner | Metric | Before | QR Lab | Change |
|---|---:|---:|---:|---:|
...
`crates/qr-lab-imgproc/tests/deblur_quality.rs` independently applies known line
...
2.2.6, and the release `qr-lab` wheel. Timings use
