...
cc -fsyntax-only -I "$ROOT/crates/qrk-ffi/include" \
  "$ROOT/crates/qrk-ffi/examples/operator.c"

echo "OK: legacy and QRKit operator ABI symbols exported"
